...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<link rel="stylesheet" media="screen" type="text/css" href="<tpl:relativeRoot />screen.css" title="Screen" />
	</head>
	<body>
		<div id="page">
			<h1><a href="<tpl:relativeRoot />"><tpl:projectName /></a> :  code coverage of <tpl:className /></h1>
			<div id="content">
